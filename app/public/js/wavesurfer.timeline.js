                            ...
                            function TimelinePlugin(params, ws) {
                                ...
                                this.params = this.util.extend(
                                    {},
                                    {
                                        ...
                                        zoomDebounce: false,
                                        formatTimeCallback:
                                            this.defaultFormatTimeCallback,
                                        timeInterval: this.defaultTimeInterval,
                                        primaryLabelInterval:
                                            this.defaultPrimaryLabelInterval,
                                        secondaryLabelInterval:
                                            this.defaultSecondaryLabelInterval,
                                    },
                                    params
                                );
                                /** @private */
                            ...
                            _createClass(TimelinePlugin, [
                                ...
                                },
                                {
                                    ...
                                    value: function updateCanvasesPositioning() {
                                        ...
                                        var canvasesLength =
                                            this.canvases.length;
                                        this.canvases.forEach(function (
                                            canvas,
                                            i
                                        ) {
                                            ...
                                            var canvasWidth =
                                                i === canvasesLength - 1
                                                    ? _this3.drawer.wrapper
                                                          .scrollWidth -
                                                      _this3.maxCanvasElementWidth *
                                                          (canvasesLength - 1)
                                                    : _this3.maxCanvasElementWidth; // set dimensions and style

                                            canvas.width =
                                                canvasWidth * _this3.pixelRatio; // on certain pixel ratios the canvas appears cut off at the bottom,
                                            // therefore leave 1px extra

                                            canvas.height =
                                                (_this3.params.height + 1) *
                                                _this3.pixelRatio;
                                ...
                                },
                                {
                                    ...
                                    value: function renderCanvases() {
                                        ...
                                        var height2 =
                                            this.params.height *
                                            (this.params.notchPercentHeight /
                                                100) *
                                            this.pixelRatio;
                                        var pixelsPerSecond = width / duration;
                                        var formatTime =
                                            this.params.formatTimeCallback; // if parameter is function, call the function with
                                        // pixelsPerSecond, otherwise simply take the value as-is

                                        var intervalFnOrVal =
                                            function intervalFnOrVal(option) {
                                        ...
                                        var primaryLabelInterval =
                                            intervalFnOrVal(
                                                this.params.primaryLabelInterval
                                            );
                                        var secondaryLabelInterval =
                                            intervalFnOrVal(
                                                this.params
                                                    .secondaryLabelInterval
                                            );
                                        ...
                                        var renderPositions =
                                            function renderPositions(cb) {
                                                positioning.forEach(function (
                                                    pos
                                                ) {
                                        ...
                                        this.setFonts(
                                            ""
                                                .concat(fontSize, "px ")
                                                .concat(this.params.fontFamily)
                                        );
                                        this.setFillStyles(
                                            this.params.primaryFontColor
                                        );
                                        ...
                                        this.setFillStyles(
                                            this.params.secondaryFontColor
                                        );
                                        renderPositions(function (
                                            i,
                                            curSeconds,
                                        ...
                                        this.setFillStyles(
                                            this.params.unlabeledNotchColor
                                        );
                                        renderPositions(function (
                                            i,
                                            curSeconds,
                                ...
                                },
                                {
                                    ...
                                    value: function defaultFormatTimeCallback(
                                        seconds,
                                        pxPerSec
                                    ) {
                                        if (seconds / 60 > 1) {
                                ...
                                },
                                {
                                    ...
                                    value: function defaultTimeInterval(
                                        pxPerSec
                                    ) {
                                        if (pxPerSec >= 25) {
                                            return 1;
                                ...
                                },
                                {
                                    ...
                                    value: function defaultPrimaryLabelInterval(
                                        pxPerSec
                                    ) {
                                        if (pxPerSec >= 25) {
                                            return 10;
                                ...
                                },
                                {
                                    ...
                                    value: function defaultSecondaryLabelInterval(
                                        pxPerSec
                                    ) {
                                        if (pxPerSec >= 25) {
                                            return 5;
                    ...
                    var _initialiseProps = function _initialiseProps() {
                        ...
                        this._onScroll = function () {
                            if (_this6.wrapper && _this6.drawer.wrapper) {
                                _this6.wrapper.scrollLeft =
                                    _this6.drawer.wrapper.scrollLeft;
                            }
                        };
                        ...
                        this._onWrapperClick = function (e) {
                            ...
                            _this6.fireEvent(
                                "click",
                                relX / _this6.wrapper.scrollWidth || 0
                            );
                        };
                    };
