                    ...
                    var Region =
                        ...
                        (function () {
                            function Region(params, ws) {
                                ...
                                this.scroll =
                                    params.scroll !== false &&
                                    ws.params.scrollParent;
                                this.scrollSpeed = params.scrollSpeed || 1;
                                this.scrollThreshold =
                                    params.scrollThreshold || 10;
                                this.bindInOut();
                                this.render();
                            ...
                            _createClass(Region, [
                                ...
                                },
                                {
                                    ...
                                    value: function render() {
                                        ...
                                        regionEl.className =
                                            "wavesurfer-region";
                                        regionEl.title = this.formatTime(
                                            this.start,
                                            this.end
                                        );
                                ...
                                },
                                {
                                    ...
                                    value: function updateRender() {
                                        ...
                                        if (this.element != null) {
                                            ...
                                            var left = Math.round(
                                                (startLimited / dur) * width
                                            );
                                            var regionWidth =
                                                Math.round(
                                                    (endLimited / dur) * width
                                                ) - left;
                                ...
                                },
                                {
                                    ...
                                    value: function bindInOut() {
                                        ...
                                        this.wavesurfer.backend.on(
                                            "audioprocess",
                                            onProcess
                                        );
                                        this.on("remove", function () {
                                            _this3.wavesurfer.backend.un(
                                                "audioprocess",
                                                onProcess
                                            );
                                        });
                                            ...
                                            (function () {
                                                ...
                                                var edgeScroll =
                                                    function edgeScroll(e) {
                                                        ...
                                                        var time =
                                                            _this4.wavesurfer.drawer.handleEvent(
                                                                e
                                                            ) * duration;
                                                        var delta =
                                                            time - startTime;
                                                ...
                                                var onDown = function onDown(
                                                    ...
                                                    maxScroll =
                                                        ...
                                                        _this4.wrapper
                                                            .clientWidth;
                                                    wrapperRect =
                                                        _this4.wrapper.getBoundingClientRect();
                                                    ...
                                                    if (drag || resize) {
                                                        ...
                                                        if (
                                                            ...
                                                            if (drag) {
                                                                ...
                                                                var regionRect =
                                                                    _this4.element.getBoundingClientRect();

                                                                var x =
                                                                    regionRect.left -
                                                                    wrapperRect.left; // Check direction
                                                ...
                                                _this4.element.addEventListener(
                                                    "mousedown",
                                                    onDown
                                                );
                        ...
                        (function () {
                            ...
                            function RegionsPlugin(params, ws) {
                                ...
                                observerPrototypeKeys.forEach(function (key) {
                                    Region.prototype[key] =
                                        _this5.util.Observer.prototype[key];
                                });
                                this.wavesurfer.Region = Region;

                                this._onBackendCreated = function () {
                                    _this5.wrapper =
                                        _this5.wavesurfer.drawer.wrapper;

                                    if (_this5.params.regions) {
                                        _this5.params.regions.forEach(function (
                                            region
                                        ) {
                                            _this5.add(region);
                                        });
                                ...
                                this._onReady = function () {
                                    if (_this5.params.dragSelection) {
                                        _this5.enableDragSelection(
                                            _this5.params
                                        );
                                    }

                                    Object.keys(_this5.list).forEach(function (
                                        id
                                    ) {
                            ...
                            _createClass(RegionsPlugin, [
                                ...
                                },
                                {
                                    ...
                                    value: function enableDragSelection(
                                        params
                                    ) {
                                        var _this8 = this;
                                        ...
                                        var container =
                                            this.wavesurfer.drawer.container;
                                        var scroll =
                                            params.scroll !== false &&
                                        ...
                                        var edgeScroll = function edgeScroll(
                                            ...
                                            var end =
                                                _this8.wavesurfer.drawer.handleEvent(
                                                    e
                                                );
                                        ...
                                        var eventDown = function eventDown(e) {
                                            ...
                                            maxScroll =
                                                _this8.wrapper.scrollWidth -
                                                _this8.wrapper.clientWidth;
                                            wrapperRect =
                                                _this8.wrapper.getBoundingClientRect();
                                            drag = true;
                                            start =
                                                _this8.wavesurfer.drawer.handleEvent(
                                                    e,
