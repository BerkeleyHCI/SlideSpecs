                        ...
                        (function () {
                            ...
                            function CursorPlugin(params, ws) {
                                ...
                                this._onMousemove = function (e) {
                                    var bbox =
                                        _this.wavesurfer.container.getBoundingClientRect();
                            ...
                            _createClass(CursorPlugin, [
                                        ...
                                        if (this.params.showTime) {
                                            ...
                                            var elementWidth =
                                                ...
                                                this.wavesurfer.params
                                                    .pixelRatio;
                                            var scrollWidth =
                                                this.wavesurfer.drawer.getScrollX();
                                            var scrollTime =
                                                (duration /
                                                    this.wavesurfer.drawer
                                                        .width) *
                                                scrollWidth;
                                            var timeValue =
                                                Math.max(
                                ...
                                },
                                {
                                    ...
                                    value: function formatTime(cursorTime) {
                                        return [cursorTime].map(function (
                                            time
                                        ) {
                                            return [
